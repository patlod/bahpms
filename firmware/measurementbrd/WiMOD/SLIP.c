...
#define SLIP_END		0xC0	// 0d192
#define SLIP_ESC		0xDB 	// 0d219
#define SLIP_ESC_END	0xDC 	// 0d220
#define SLIP_ESC_ESC	0xDD	// 0d221
...
//	DecodeData
//
//	@brief: process received byte streambuf
// 
//------------------------------------------------------------------------------
				...
				switch (rxByte)
				{
					case SLIP_END:
						...
						if(SLIP.RxIndex > 0)
						{
							...
							if(SLIP.CbRxMessage)
							{
								// yes, call message received
								// Returns either a pointer two reseted buffer or null.
...
if (SLIP.TxIndex < SLIP.TxBufferSize) SLIP.TxBuffer[SLIP.TxIndex++] = txByte;
}
